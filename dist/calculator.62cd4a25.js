...
function displaySummary(name) {
    ...
    if (inputValues[name]) line.style.display = "block";
    else line.style.display = "none";
    console.log(line);
}
//calculator functionality
function handleInputChange(e) {
    if (e.target.type != "checkbox") inputValues[e.target.name] = e.target.value ? e.target.value : false;
    else inputValues[e.target.name] = e.target.checked ? true : false;
